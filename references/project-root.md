...
Rules: print `project=<slug> home=<path> ticket=<id> worklog=<path> locale=<code>` at each stage start; prefer existing home; keep artifacts outside child repos unless user asks.
