...
name: build
description: >-
  TDD then implement only after coaching/spec/conflict/plan gates pass.
...
Implement only after prior gates pass.
Use TDD and log AC/claim-to-test mapping in `templates/05-impl-log.md`.
Run `/dev-workflow:check <Ticket> [slug] G5` before any G5 PASS claim.
